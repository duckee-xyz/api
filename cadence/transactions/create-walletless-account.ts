const CREATE_WALLETLESS_ACCOUNT = `
import DuckeeArtNFT from 0xDuckeeArtNFT
import DuckeePromptSBT from 0xDuckeePromptSBT
import DuckToken from 0xDuckToken
...
transaction (
    ...
    prepare(signer: AuthAccount) {
        ...
        let collectionCapability= newAccount.link<&DuckeeArtNFT.Collection>(/private/PromptMarketSaleCollection, target: DuckeeArtNFT.CollectionStoragePath)
...
export default CREATE_WALLETLESS_ACCOUNT;
